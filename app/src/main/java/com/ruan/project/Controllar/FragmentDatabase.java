...
public class FragmentDatabase {
     ...
     * @return
     */
    public static ArrayList<Map<String, String>> getUserDeviceData(Context context) {
        //获取所有的设备ID
        //从数据库中获取设备的ID
        new CreateDataBase().FirstDataBase(context, DatabaseTableName.DeviceDatabaseName, DatabaseTableName.UserDeviceName);
        return new GetDatabaseData().QueryArray(context, DatabaseTableName.DeviceDatabaseName, DatabaseTableName.UserDeviceName, null, "", null, "", "", "", "");
    }
